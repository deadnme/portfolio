...
window.PORTFOLIO_DATA = {
  featured: {
    ...
    metrics: [
      ...
      { value: '~6,700 → 0', label: 'Forced <code>getComputedStyle</code> calls per second' },
      { value: '3 ms', label: 'Per-frame occlusion sampling budget, round-robin across emotes' },
      { value: '192 MB', label: 'ImageBitmap LRU cap, evicting only emotes that are off screen' }
    ]
  }
};
